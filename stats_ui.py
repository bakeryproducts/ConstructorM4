...
class Ui_wid_stats(QtGui.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.gridLayout_30.addItem(spacerItem9, 0, 0, 1, 1)
        self.label_51 = QtGui.QLabel(self.tab_normaly)
        self.label_51.setObjectName(_fromUtf8("label_51"))
        self.gridLayout_30.addWidget(self.label_51, 0, 1, 1, 1)
        self.ln_yrsigma = QtGui.QLineEdit(self.tab_normaly)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ln_yrsigma.sizePolicy().hasHeightForWidth())
        self.ln_yrsigma.setSizePolicy(sizePolicy)
        self.ln_yrsigma.setMaximumSize(QtCore.QSize(80, 16777215))
        self.ln_yrsigma.setAlignment(QtCore.Qt.AlignCenter)
        self.ln_yrsigma.setObjectName(_fromUtf8("ln_yrsigma"))
        self.gridLayout_30.addWidget(self.ln_yrsigma, 1, 2, 1, 1)
        ...
        self.gridLayout_31.addItem(spacerItem10, 0, 0, 1, 1)
        ...
        self.gridLayout_32.addItem(spacerItem11, 0, 0, 1, 1)
        ...
        self.gridLayout_33.addItem(spacerItem12, 1, 0, 1, 1)
        ...
        self.gridLayout_35.addItem(spacerItem14, 0, 0, 1, 1)
        ...
        self.gridLayout_36.addItem(spacerItem15, 0, 0, 1, 1)
        ...
        self.gridLayout_37.addItem(spacerItem16, 0, 0, 1, 1)
        ...
        self.gridLayout_38.addItem(spacerItem17, 0, 0, 1, 1)
    ...
    def probdet(self):
        ...
        if j == 0:
            yparams = [self.mainwindow.glwidget.he / 2 - float(self.ln_ynrmu.text()), float(self.ln_yrsigma.text())]
    ...
    def newrow(self,n, obj,face,thick,ci,angle):
    ...
    def resultsconvert(self):
        ...
        for r in res:
            ...
            #lookvec = self.lookp1
            angle = str(getangle(comp.geoobj.getnormaltoface(faceid),lookvec))
            self.newrow(str(n),cname,face,thick,ci,angle)
            if n in shotdict.keys():
                shotdict[n].append(cname)
            else:
                shotdict[n] = [cname]
    ...
    def tblresselect(self):
        if self.tbl_res.item(self.tbl_res.currentRow(),4):
            cistr = self.tbl_res.item(self.tbl_res.currentRow(),4).text()
