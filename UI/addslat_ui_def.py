...
# Form implementation generated from reading ui file 'addslat.ui'
#
...
class Ui_wid_addslat(object):
    ...
    def retranslateUi(self, wid_addslat):
        ...
        self.ln_thick.setText(_translate("wid_addslat", "100", None))
        self.label_5.setText(_translate("wid_addslat", "Depth: ", None))
        self.ln_depth.setText(_translate("wid_addslat", "100", None))
